...
class Weekly extends Object {
  ...
  Weekly(this.itemList,this.count,this.total,this.adExist,);

  factory Weekly.fromJson(Map<String, dynamic> srcJson) => _$WeeklyFromJson(srcJson);

  Map<String, dynamic> toJson() => _$WeeklyToJson(this);
...
class Tags extends Object {
  ...
  Tags(this.id,this.name,this.actionUrl,this.bgPicture,this.headerImage,this.tagRecType,this.communityIndex,);
